    ...
    data: [
      {
        ...
        features: JSON.stringify([
          "Servidores públicos: Warmup, DM, Retakes e ForFun",
          "Perfil público e visualização do ranking global",
          "Quick Connect padrão",
          "Inventário básico (sem agentes e stickers)",
        ]),
        cta: "Começar grátis",
        sortOrder: 0,
      },
      {
        ...
        features: JSON.stringify([
          "Tudo do plano Free",
          "Fila ranqueada 5v5 com ELO e seasons",
          "Criar salas no Lobby",
          "Prioridade de vaga em servidores cheios",
          "Skins expandidas, agentes e 2 slots de stickers",
          "Tag Premium no perfil e cargo no Discord",
        ]),
        cta: "Assinar Premium",
        sortOrder: 1,
      },
      {
        ...
        features: JSON.stringify([
          ...
          "Personalização avançada de perfil (Elite)",
          "Criar clã como owner Elite",
          "4 slots de stickers no inventário",
          "Estatísticas avançadas no perfil",
          "Cargo Elite no Discord",
        ]),
        cta: "Virar Elite",
        sortOrder: 2,
      },
